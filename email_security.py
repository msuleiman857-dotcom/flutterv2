                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <tr>
                      <td style="padding: 0 40px 20px 40px;">
                        ...
                        <p style="margin: 0 0 32px 0; font-size: 15px; color: #666666; line-height: 1.6;">
                          We received a request to verify the email address for your TetherX account. Enter the secure 6-digit code below to continue. This code will expire in <strong>10 minutes</strong>.
                        </p>
